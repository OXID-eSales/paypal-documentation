...
In this chapter, the installation of the PayPal module for the OXID eShop version 6.4 is described.
...
* PHP versions 7 and 8, as from 7.1 and 8.0
* cURL
* OpenSSL
...
.. code:: bash
  ...
  composer require --update-no-dev oxid-esales/paypal-module:^6.4.0
