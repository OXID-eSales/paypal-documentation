...
In this chapter, the installation of the PayPal module for the OXID eShop version 6.5 is described.
...
.. code:: bash
  ...
  composer require --update-no-dev oxid-esales/paypal-module:^6.5.0
